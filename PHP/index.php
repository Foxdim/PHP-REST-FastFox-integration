<?php 
include_once("fastfox_module.php");
...
$fastfox = new FastFox_Foxdim_Module($API_INFORMATION_ARR);
...
switch ($process) {
    case 'test_connection':
        ...
        */
        ...
        $created_package=$fastfox->create_package($package_arr);
        print_r($created_package);die;
        break;
        
        case 'delete_packages':
        echo "<h3>Delete Packages for barcodes</h3>";
        $delete_packages=$fastfox->delete_packages("567256076322");
